...
export function email(
  ...
  const emailComrpador = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                ...
                <tr>
                    <td class="esd-email-paddings" valign="top">
                                                                ...
                                                                <tr>
                                                                    <td width="530" class="es-m-p0r esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://demo.stripocdn.email/content/guids/videoImgGuid/images/84511620371376002.png" alt style="display: block;" height="51"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p25b es-p35r es-p35l" align="center" style="font-size:0"><a target="_blank" href="https://viewstripo.email/"><img src="https://tlr.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/67611522142640957.png" alt style="display: block;" width="115"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p20b" align="left">
                                                                                        <p style="font-size: 16px; color: #777777;">${hola} ${usuari},&nbsp;${gracies}<span style="background-color:null;"><strong><span style="color:#790726;"> EMBUTIDOS AGUILÓ, S.L.</span></strong></span></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="esd-block-text es-p10b" align="left">
                                                                                        <p>${via}, ${domicili} ${num} ${ pis === undefined ? "" : pis} ${  escala === undefined
                                                                                            ? ""
                                                                                            : escala} ${   porta === undefined
                                                                                                ? ""
                                                                                                : porta}</p>
                                                                                        <p>${prov}, ${cp}</p>
                                                                                        <p>${pais}</p>
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="7797" align="center" esdev-config="h1">
                                        <table class="es-content-body" style="background-color: #790726;" width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#790726">
                                            <tbody>
                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="center">
                                                                                        <h2 style="color: #ffffff; font-size: 24px;">${confi}</h2>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                ...
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="7684" align="center">
                                        <table class="es-footer-body" width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#790726" style="background-color: #790726;">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p40b es-p35r es-p35l" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p15b" align="center" style="font-size: 0px;"><a target="_blank"><img src="https://demo.stripocdn.email/content/guids/78b30769-87b8-4954-b58a-d232d7b3eb63/images/69751620372276110.png" alt="Beretun logo" style="display: block;" title="Beretun logo" width="42"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="center">
                                                                                        <p style="color: #ffffff;">EMBUTIDOS AGUILÓ, S.L.<br>Avenida de Asturias, 4-A<br>07100-Soller (Illes Balears)<br>Nif:B-07002827<br>Telf (34) 971630168<br>Email:laluna@la-luna.es</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
