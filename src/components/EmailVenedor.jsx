                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="530" align="left">
                                                                         ...
                                                                         <thead>
                                                                               <tr>
                                                                                  <th style ="font-weight: bold; text-align: left;">${tipusVia}</th>
                                                                                  <th style ="font-weight: bold; text-align: left;">${traDomicili} </th>
                                                                                  <th style ="font-weight: bold; text-align: left;">${traNum}</th>        
                                                                                  <th style ="font-weight: bold; text-align: left;">${traEscala}</th>
                                                                                  <th style ="font-weight: bold; text-align: left;">${traPis}</th>
                                                                                  <th style ="font-weight: bold; text-align: left;">${traPorta} </th>
                                                                                </tr> 
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: left;">${domicili}  </td>
                                                                        ...
                                                                        <thead>
                                                                          ...
                                                                          <tbody>
                                                                             <tr>
                                                                                <td style="text-align: left;">${correu}</td>
